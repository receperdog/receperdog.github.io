    ...
    <footer className="bg-white dark:bg-gray-900 py-12 border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Software engineer with a passion for building reliable, scalable, and maintainable web applications.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:rerdogan@receperdogan.dev" className="text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800 text-center text-gray-600 dark:text-gray-400">
          <p>© {currentYear} Recep Erdogan. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
